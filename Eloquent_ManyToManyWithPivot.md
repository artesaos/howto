...
## Relacionamentos Muitos para Muitos com mais campos na tabela segue a relação ![https://github.com/artesaos/howto/blob/master/Eloquent_ManyToMany.md] com adição de um campo na tabela Pivot de nome `status`, como segue figura logo abaixo:
